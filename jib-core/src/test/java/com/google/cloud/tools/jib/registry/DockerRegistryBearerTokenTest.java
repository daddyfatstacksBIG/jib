...
/**
 * Tests for {@link RegistryClient} around handling of Docker Registry Bearer
 * Tokens.
 *
 * <p>JWTs were generated from <a href="https://jwt.io">jwt.io</a>'s <em>JWT
 * Debugger</em>. Set the algorithm to HS256, and paste the JSON shown as the
 * <em>Payload</em>.
 */
public class DockerRegistryBearerTokenTest {
  ...
  public void testDecode_dockerToken() {
    ...
    Multimap<String, String> decoded = RegistryClient.decodeTokenRepositoryGrants(
  ...
  public void testDecode_nonToken() {
    String base64Text = Base64.encodeBase64String(
        "something other than a JWT token".getBytes(StandardCharsets.UTF_8));
    Multimap<String, String> decoded =
        RegistryClient.decodeTokenRepositoryGrants(base64Text);
  ...
  public void testDecode_invalidToken_accessString() {
    ...
    Multimap<String, String> decoded =
        RegistryClient.decodeTokenRepositoryGrants(jwt);
    Assert.assertNull(decoded);
  }
  ...
  @Test
  @Ignore(
      "Annotate AccessClaim.actions to disallow coercion of integers to strings")
  public void
  testDecode_invalidToken_actionsArray() {
    // a JWT with an "access" field that is an action array of non-strings:
    // {"access":[{"type": "repository","name":
    // "library/openjdk","actions":[1]}]}
    String jwt =
  ...
  public void testCanAttemptBlobMount_basicToken() {
    ...
    Assert.assertTrue(
        RegistryClient.canAttemptBlobMount(fixture, "library/openjdk"));
    Assert.assertTrue(
        RegistryClient.canAttemptBlobMount(fixture, "randomrepo"));
  }
  ...
  public void testCanAttemptBlobMount_bearer_withToken() {
    ...
    Assert.assertTrue(
        RegistryClient.canAttemptBlobMount(authorization, "library/openjdk"));
    Assert.assertFalse(
        RegistryClient.canAttemptBlobMount(authorization, "randomrepo"));
  }
