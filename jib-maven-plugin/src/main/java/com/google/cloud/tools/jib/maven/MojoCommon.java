...
public class MojoCommon {
  ...
  public static final String VERSION_URL =
      "https://storage.googleapis.com/jib-versions/jib-maven";

  static Future<Optional<String>>
  newUpdateChecker(ProjectProperties projectProperties, Log logger) {
  ...
  static void finishUpdateChecker(ProjectProperties projectProperties,
    ...
    UpdateChecker.finishUpdateCheck(updateCheckFuture)
        .ifPresent(updateMessage -> {
          projectProperties.log(LogEvent.lifecycle(""));
          projectProperties.log(
              LogEvent.lifecycle("\u001B[33m" + updateMessage + "\u001B[0m"));
          projectProperties.log(LogEvent.lifecycle(
              "\u001B[33m" + ProjectInfo.GITHUB_URL +
