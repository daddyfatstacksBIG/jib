 ...
 *
 * <p>Expected use: {@code mvn jib:_skaffold-fail-if-jib-out-of-date
 * -Djib.requiredVersion='[1.4,2)' jib:build -Dimage=xxx}
 */
@Mojo(name = CheckJibVersionMojo.GOAL_NAME, requiresProject = false,
